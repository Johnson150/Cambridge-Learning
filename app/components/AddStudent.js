...
const AddStudent = ({ refreshStudents }) => {
    ...
    const [grade, setGrade] = useState(""); // New grade field
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (refreshStudents) {
                refreshStudents(); // Refresh the student list if the function is provided
            }
            setTimeout(() => {
            ...
            <Modal showModal={showModal} setShowModal={setShowModal}>
                <div className="bg-white p-6 rounded-lg shadow-lg"> {/* Set a white background for the modal content */}
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Grade</label> {/* Add grade input */}
                            <input
                                type="number"
                                value={grade}
